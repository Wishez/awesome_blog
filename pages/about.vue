<template>
  <div class="about" :class="{'mobile': mobileLayout}">
    <div class="title" >
      <span class="title-name">Обо мне</span>
    ...
    <div class="info-box" :class="{'info-mobile': mobileLayout}">
      <div class="info ">
        <div class="list">
          ...
          <span class="list-content">Филипп Журавлёв, <span >парень, который любит свою работу.</span></span>
        </div>
        <div class="list">
          <i class="iconfont icon-like"></i>
          <span class="list-content">Программирование, чтение, исскуство и музыка.</span>
        </div>
        <div class="list">
          <i class="iconfont icon-music"></i>
          <span class="list-content">Блюз, рок и классика.</span>
        </div>
        <div class="list">
        ...
        <div class="list">
          ...
          <span class="list-content icons">
            <a href="https://github.com/whiskez" target="_blank"><i class="iconfont icon-github"></i></a>
            ...
            <a href="mailto:shiningfinger@list.ru" target="_blank"><i class="iconfont icon-email"></i></a>
            <a
            href="javascript:;" 
            class="wechat"
